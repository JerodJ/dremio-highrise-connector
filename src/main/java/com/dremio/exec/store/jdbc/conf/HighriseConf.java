...
@SourceType(value = "HighriseARP", label = "Highrise",uiConfig = "highrise-layout.json")
public class HighriseConf extends AbstractArpConf<HighriseConf> {
  private static final String ARP_FILENAME = "arp/implementation/highrise-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.highrise.HighriseDriver";
